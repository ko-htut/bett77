...
(function(f) {
    f.fn.marquee = function(x) {
        return this.each(function() {
            ...
            if ("string" === typeof x)
                f.isFunction(p[x]) && (c || (c = b.find(".js-marquee-wrapper")), !0 === b.data("css3AnimationIsSupported") && (n = !0), p[x]());
            else {
                var v;
                ...
                c = b.find(".js-marquee-wrapper");
                 if (u) {
                    ...
                    k = b.find(".js-marquee:first").width() +
                ...
                m + "px": "-" + (2 * q - a.gap) + "px"): a.startVisible ? c.css("margin-left", 0) : c.css("margin-left", "left" == a.direction ? h + "px" : "-" + (2 * k - a.gap) + "px"),
