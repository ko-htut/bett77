function adduser(data){
  ...
  if(index==undefined)
  {
    ...
    var html='<div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html += '<div style="position: relative;"><div style="position: absolute; z-index: 880; display: none;" class="watchzt" ><img src="http://33uuK.helphand.cn/img/jhgz/guest_avatar.png"/ style="width: 100%;margin-top:0.01vh;margin-left:0.7vw "></div></div>'
   ...
   var sj=data;
    img.onload = function(){
        ...
        for(var i=0;i<sj.user.length;i++){
            ...
            ctx.font = "31px 微软雅黑";
            ctx.fillStyle = "#d8cb66";
            ctx.fillText(decode64(user.nickname).substring(0, 10), 225, 376+i*105);
            if(user.dqjf>0){
                user.dqjf='+'+user.dqjf;
            }else{
                ctx.fillStyle = "#fff";
