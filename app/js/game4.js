...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='http://33cdn.bepkwl.cn/yx/img/point'+allcardxx['niu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='http://33cdn.bepkwl.cn/yx/img/point'+allcardxx['niu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<img src="http://33cdn.bepkwl.cn/yx/img/bull9/playerWin.png" class="banker" style="display: none;" /> '
    ...
    html+='<img id="banker213612" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     html+='<img src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_icon.png" class="background jiurenniuniu-background1" style="height: 2.6vh;" />'
     html+='<img id="bankerAnimate'+indexuser+'" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_animate.png" class="jiurenniuniu-background2" />' 
     html+='<img id="bankerAnimate1'+indexuser+'" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_animate.png" class="jiurenniuniu-background2" /><div class="isReady" style="display:none"><img src="http://goss.fexteam.com/files/d_25/images/game/ready.png " class="ready" style=""></div></div>';
     $('#member').append(html);
     if(data.user.zt==1){
...
if(typeof(winMl) == 'undefined'){
  ...
  for(var i=0;i<8;i++){
     var html='<div class="memberCoin member'+win+lose+'"  ><img src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_coin.png" class="liurenniuniu-memberCoin" /></div>'
     $('#jinbi').append(html);
...
function showxian(data){
    ...
    msgxx.img='http://33cdn.bepkwl.cn/yx/img/X-'+data.zt+'.png';
...
function qbankshow(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_text_'+bankwz+'.png">'
            ...
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="http://33cdn.bepkwl.cn/yx/img/X-'+data.zt+'.png"></div>'
        }
        else{
            html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;">'
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_text_'+bankwz+'.png"></div>'
        }
        mp3xx='qiangzhuang';
    }
    else{
        html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;">';
        html+='<img class="jiurenniuniu-qiangzhuangs-img" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_text_not'+bankwz+'.png"></div>';
        mp3xx='buqiang';
    }
...
function qbankshowother(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            msgxx.img='http://33cdn.bepkwl.cn/yx/img/bull9/bull_text_'+bankwz+'.png';
        ...
        msgxx.img='http://33cdn.bepkwl.cn/yx/img/bull9/bull_text_not'+bankwz+'.png';
        showmemberRobText(msgxx);
        mp3xx='buqiang';
    }
    mp3play(mp3xx);
     ...
     ctx.font = "27px 微软雅黑";
       ...
       for(var i=0;i<sj.user.length;i++){
            if(i>1){
                ...
                ctx.fillRect(142,540-(0-(i-2)*103),519,96);
            }
            var user=sj['user'][i];
            ctx.font = "35px 微软雅黑";
            ctx.fillStyle = "#d8cb66";
            //ctx.fillText(user.id, 195, 380+(i*75));
            ctx.fillText(decode64(user.nickname).substring(0,9), 225, 350+(i*90));
            if(user.dqjf>0){
                user.dqjf='+'+user.dqjf;
            }else{
                ctx.fillStyle = "#fff";
                ctx.fillText(decode64(user.nickname).substring(0,9), 225, 350+(i*90));
                ctx.fillText(user.dqjf, 530, 350+(i*90));
            }
            ctx.fillText( user.dqjf, 530, 350+(i*90));
        }
...
function operationButton(data){
    ...
    if(data=='1'){
        ...
        html+='                        <img class="operationButton-3" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_button_orange.png">'
        ...
        html+='                        <img class="operationButton-gg" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_button_blue.png"> '
        html+='                        <div class="operationButton-3-ts" >'
        html+='不上'
        html+='                        </div>'
        html+='                       </div>'
    ...
    if(data=='2'){
        ...
        html+='             <img src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_times_bg1.png"  class="operationButton-gg"  /> '
        ...
        html+='              <img src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_times_bg_blue.png"  class="operationButton-gg"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='8'){
        iszhunbeitwo = 1; 
        html+='<div class="operationButton-1-zt"><img class="operationButton-1" id="zb" src="http://33cdn.bepkwl.cn/yx/img/bull9/readyButton.png" onClick="zhunbei()"></div>';
        }
    }

    if(data=='9'){
        html+='<div class="operationButton-2-zt"><img id="zbs" class="operationButton-2" src="http://33cdn.bepkwl.cn/yx/img/bull9/ready.png" style="display:block;"></div>';
    }
