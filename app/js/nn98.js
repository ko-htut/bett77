...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='http://33cdn.bepkwl.cn/yx/img/niu'+allcardxx['niu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='http://33cdn.bepkwl.cn/yx/img/niu'+allcardxx['niu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    html+='<img id="banker213612" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     html+='<img src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_icon.png" class="background jiurenniuniu-background1" />' 
     ...
     html+='<img id="bankerAnimate1'+indexuser+'" src="http://33cdn.bepkwl.cn/yx/img/bull9/bull_banker_animate.png" class="jiurenniuniu-background2" /><div class="isReady" style="display:none"><img src="http://33cdn.bepkwl.cn/dy/9rnn/ready.png " class="ready" style=""></div></div>';
     $('#member').append(html);
     if(data.user.zt==1){
...
function initroom(){
    ...
    //script.src="http://33cdn.bepkwl.cn/yx/js/robat.js";  
...
function operationButton(data){
    ...
    if(data=='2'){
        ...
        html+='              <img src="http://cdn6.8848dai.com/app/img/bull9/bull_button_blue777.png"  class="operationButton-gg11"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='4'){
        ...
        html+='             </div>' 
        html+='             <div class="divCoin divCoin4" style="display: inline-block;'
        html+='            z-index: 200;" onclick="xianxz(8);">'
        html+='              <img src="/app/img/bull9/bull_times_bg1.png"  class="operationButton-gg11"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               8倍'
        html+='              </div>'
    ...
    if(data=='7'){
        ...
        html+='<img class="operationButton-gg" src="http://cdn6.8848dai.com/app/img/bull9/bull_button_blue.png"  /> ';
    ...
    if(data=='8'){
        ...
        html+='<img class="operationButton-gg11" src="/images/chajian/y1.png"  /> ';
