...
/**
 * 入口文件
 * 警告：不要修改此文件，否则可能导致程序运行 QQ: 2054970171
 * h5 棋牌 APP 搭建开发     直播系统搭建  微信：kadiym   或  fcxcx688
 */
...
//项目路径，不可更改
define('APP_PATH', SITE_PATH . '668yuanmacom/');
//项目相对路径，不可更改
define('SPAPP_PATH',   SITE_PATH.'668yuanma/');
//
define('SPAPP',   './668yuanmacom/');
//项目资源目录，不可更改
define('SPSTATIC',   SITE_PATH.'statics/');
//定义缓存存放路径
define("RUNTIME_PATH", SITE_PATH . "game/668yuanmacom/");
//静态缓存目录
define("HTML_PATH", SITE_PATH . "game/668yuanmacom/Html/");
//版本号
