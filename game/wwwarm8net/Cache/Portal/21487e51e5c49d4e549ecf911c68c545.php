...
<title>十人牛牛<?php echo ($room["roomid"]); ?></title>
<?php echo base64_decode(''); ?></script>
...
<script type="text/javascript" src="/app/js/base64.js"></script>
    ...
    <script src="http://lyuu.poyio.cn/files/10ren/js/vue.min.js" type="text/javascript"></script> 
...
function randomString(len) {
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号十人房间';//分享的标题
  ...
  //var desc = 'http://'+window.location.hostname+'/jf/bn/'+randomString(12);
...
<html>
 ...
 <body style="overflow: hidden;"> 
   ...
   <style>
  .watch .mainPart{position: absolute;top: 42%;left: 50%; z-index: 100; margin-left:-22.5vh ;width: 45vh;background:url("http://33uuK.helphand.cn/img/back88.png");background-size:100% 100%;border-radius: 1.5vh; height: 59vh;margin-top: -29.5vh}
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <div class="jiurenniuniu-round"></div> 
   <div class="round " style="" id="jsxx">
    <?php echo ($room["js"]); ?>&nbsp;/&nbsp;<?php echo ($room["zjs"]); ?>局
   </div> 
<style>    
#room_str{position:fixed;top:-300px;}
.copyUrl{position: fixed;width:62px;height:24px;position:absolute;top:34px;right:19px;z-index:999;border: none;background: url(http://lelefile3.zhenglvyou.com/files/images/copy/copyicon.png);background-size: 100%;}
...
<textarea id="room_str" value=""> 十人牛牛<?php echo ($room["roomid"]); ?>号房间
...
<div class="copyUrl" data-clipboard-action="copy" data-clipboard-target="#copyUrl">  
 ...
 <img src="http://qq8790766.cdn.bcebos.com/app/img/bull9/btn_game_home.png" class="return"  onclick="opnemm('fangjian_fanhuisy','tishi')" />  
   <img src="http://qq8790766.cdn.bcebos.com/app/img/bull9/btn_game_rule.png" class="bGameRule jiurenniuniu-bGameRule" onclick="opnemm('fangjian_gz','vroomRule')" /> 
...
">
   ...
   <div class="bottomMessage"  onclick="opnemm('shiren_kj','message')">
    <img src="http://qq8790766.cdn.bcebos.com/app/img/bull9/bull_message.png" class='jiurenniuniu-bottomMessage-img'  />
   </div> 
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="http://lelefile3.zhenglvyou.com/files/images/table/laiziniuniu9.jpg" class="tableBack" /> 
...
isguanzhan = 1;
   ...
   <!--满人弹框-->
<?php if(count($room['userlist']) >= 10 && $room['userlist'][$user['id']] != 1): ?><div id="valert" class="alert">
   <div>
...
<audio onended="mp3playandpause('1miao');" id="1miao" src="/files/d_2/audio/bull6b/background3.mp3"></audio>
<audio onended="mp3playandpause('mp3niu0');" id="mp3niu0" src="/files/d_2/audio/bull6b/nobull.m4a"></audio>
<audio onended="mp3playandpause('mp3niu1');" id="mp3niu1" src="/files/d_2/audio/bull6b/bull1.m4a"></audio>
<audio onended="mp3playandpause('mp3niu2');" id="mp3niu2" src="/files/d_2/audio/bull6b/bull2.m4a"></audio>
<audio onended="mp3playandpause('mp3niu3');" id="mp3niu3" src="/files/d_2/audio/bull6b/bull3.m4a"></audio>
<audio onended="mp3playandpause('mp3niu4');" id="mp3niu4" src="/files/d_2/audio/bull6b/bull4.m4a"></audio>
<audio onended="mp3playandpause('mp3niu5');" id="mp3niu5" src="/files/d_2/audio/bull6b/bull5.m4a"></audio>
<audio onended="mp3playandpause('mp3niu6');" id="mp3niu6" src="/files/d_2/audio/bull6b/bull6.m4a"></audio>
<audio onended="mp3playandpause('mp3niu7');" id="mp3niu7" src="/files/d_2/audio/bull6b/bull7.m4a"></audio>
<audio onended="mp3playandpause('mp3niu8');" id="mp3niu8" src="/files/d_2/audio/bull6b/bull8.m4a"></audio>
<audio onended="mp3playandpause('mp3niu9');" id="mp3niu9" src="/files/d_2/audio/bull6b/bull9.m4a"></audio>
<audio onended="mp3playandpause('mp3niu10');" id="mp3niu10" src="/files/d_2/audio/bull6b/bull10.m4a"></audio>
<audio onended="mp3playandpause('mp3niu11');" id="mp3niu11" src="/app/videoo/bullfour.m4a"></audio>
<audio onended="mp3playandpause('mp3niu12');" id="mp3niu12" src="/files/d_2/audio/bull6b/bullflower.m4a"></audio>
...
<audio onended="mp3playandpause('mp3niu16');" id="mp3niu16" src="/files/d_2/audio/bull6b/bullbomb.m4a"></audio>
<audio onended="mp3playandpause('mp3niu17');" id="mp3niu17" src="/app/videoo/bulltonghuashun.m4a"></audio>
<audio onended="mp3playandpause('mp3niu18');" id="mp3niu18" src="/files/d_2/audio/bull6b/bulltiny.m4a"></audio>

<audio onended="mp3playandpause('mp3daojishi');" id="mp3daojishi" src="/app/video/daojishi.mp3"></audio>
<audio onended="mp3playandpause('mp3gold');" id="mp3gold" src="/files/d_2/audio/bull6b/coin.mp3"></audio>
...
<audio onended="mp3playandpause('message1');" id="message1" src="/files/d_2/audio/bull6b/message20.m4a"></audio>
<audio onended="mp3playandpause('message2');" id="message2" src="/files/d_2/audio/bull6b/message21.m4a"></audio>
<audio onended="mp3playandpause('message3');" id="message3" src="/files/d_2/audio/bull6b/message22.m4a"></audio>
<audio onended="mp3playandpause('message4');" id="message4" src="/files/d_2/audio/bull6b/message23.m4a"></audio>
<audio onended="mp3playandpause('message5');" id="message5" src="/files/d_2/audio/bull6b/message24.m4a"></audio>
<audio onended="mp3playandpause('message6');" id="message6" src="/files/d_2/audio/bull6b/message25.m4a"></audio>
<audio onended="mp3playandpause('message7');" id="message7" src="/files/d_2/audio/bull6b/message26.m4a"></audio>
<audio onended="mp3playandpause('message8');" id="message8" src="/files/d_2/audio/bull6b/message27.m4a"></audio>
<audio onended="mp3playandpause('message9');" id="message9" src="/files/d_2/audio/bull6b/message28.m4a"></audio>
<audio onended="mp3playandpause('message10');" id="message10" src="/files/d_2/audio/bull6b/message29.m4a"></audio>
<audio onended="mp3playandpause('message11');" id="message11" src="/files/d_2/audio/bull6b/message30.m4a"></audio>
<audio onended="mp3playandpause('message12');" id="message12" src="/files/d_2/audio/bull6b/xzykdzys.mp3"></audio>
<audio onended="mp3playandpause('message13');" id="message13" src="/files/d_2/audio/bull6b/message8.mp3"></audio>
<audio onended="mp3playandpause('message14');" id="message14" src="/files/d_2/audio/bull6b/message1.mp3"></audio>

<audio id="background" src="/files/d_2/audio/bull6b/background3.mp3" ></audio>
<!--下注抢庄-->
<audio onended="mp3playandpause('xia1');" id="xia1" src="/files/d_2/audio/bull6b/times1.m4a"></audio>
<audio onended="mp3playandpause('xia2');" id="xia2" src="/files/d_2/audio/bull6b/times2.m4a"></audio>
   <audio onended="mp3playandpause('xia3');" id="xia3" src="/files/d_2/audio/bull6b/times3.m4a"></audio>
<audio onended="mp3playandpause('xia4');" id="xia4" src="/files/d_2/audio/bull6b/times4.m4a"></audio>
<audio onended="mp3playandpause('xia5');" id="xia5" src="/files/d_2/audio/bull6b/times5.mp3"></audio>
<audio onended="mp3playandpause('xia8');" id="xia8" src="/files/d_2/audio/bull6b/times8.mp3"></audio>
   <audio onended="mp3playandpause('xia10');" id="xia10" src="/files/d_2/audio/bull6b/times10.mp3"></audio>
    <audio onended="mp3playandpause('xia6');" id="xia6" src="/files/d_2/audio/bull6b/times6.m4a"></audio>
<audio onended="mp3playandpause('qiangzhuang');" id="qiangzhuang" src="/files/d_2/audio/bull6b/robbanker.m4a"></audio>
<audio onended="mp3playandpause('buqiang');" id="buqiang" src="/files/d_2/audio/bull6b/nobanker.m4a"></audio>
