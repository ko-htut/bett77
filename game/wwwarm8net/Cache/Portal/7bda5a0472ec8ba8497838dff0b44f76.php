...
<!--吾爱微信：8790766-->
    ...
    <title><?php echo ($titlexx); ?>娱乐</title>
...
<textarea id="room_str" value="">正版天天娱乐
 链接：http://<?php echo ($_SERVER['HTTP_HOST']); ?>/y/tt</textarea>
...
<body ng-controller="myCtrl" style="background: url(http://sta177.boysmyx.com/files/d_2/images/home/bg.jpg) #000 no-repeat;background-size:100% 100%;" class="ng-scope">
...
<div class="alertTip" ng-show="isShowAlertTip">
  ...
  <div style="position:absolute;height:9vh;width:9vh;left:3vw;top:1vh;border-radius:5px;border:#7A61AD 2px solid;border-radius:5px;overflow:hidden;">
	  ...
	  <a href="/">
        <img src="http://sta177.boysmyx.com/activity/download.png" style="position:absolute;top:3vh;width:13vw;height:7.5vh;right:40vw;">
	  </a>
