...
<textarea id="room_str" value="">一方大厅
 链接：http://<?php echo ($_SERVER['HTTP_HOST']); ?>/y/yf</textarea>
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide slidepage">
             ...
             <ul class="img">
					...
					<li><span style="background:url(http://33cdn.bepkwl.cn/dt/12renjh.png) no-repeat 50% 50% / 42.5vw 24.8vw"><a ng-click="createDcx()1" onclick="send('gameserver',{id:16})"></a></span></li>
