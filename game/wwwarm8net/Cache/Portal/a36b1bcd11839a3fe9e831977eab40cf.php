...
<textarea id="room_str" value="">优优互娱一区
 链接：http://<?php echo ($_SERVER['HTTP_HOST']); ?>/y/uu</textarea>
...
<div class="alertTip" ng-show="isShowAlertTip">
  ...
  <div style="position:absolute;height:9vh;width:9vh;left:3vw;top:1vh;border-radius:5px;border:#7A61AD 2px solid;border-radius:5px;overflow:hidden;">
	...
	<img src="http://oss.zhenglvyou.com/files/images/custom/comm/uuarea1.png" style="position:absolute;top:12vh;right:0vw;z-index:100;width:14vw;">
