<?php if (!defined('THINK_PATH')) exit(); $zhuti_list = ['xx' => 'xx.png', 'tt' => 'tt.png','yf' => 'yf.png', 'xd' => 'xd.png', 'hl' => 'hl.png', 'dd' => 'dd.png', 'lele' => 'lele.png' ,'ht' => 'ht.png', 'uu' => 'yy.png', 'kk' => 'kk.png', 'ym' => 'tt1.png', 'rr' => 'rr.png', 'xdd' => 'xdd.png', 'lt' => 'lt.png' ]; ?>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://33cdn.bepkwl.cn/dy/xxx/public-fish12.css">
    <link rel="stylesheet" type="text/css" href="http://33cdn.bepkwl.cn/dy/xxx/public188.css">
    <link rel="stylesheet" href="http://33cdn.bepkwl.cn/dy/xxx/app.css">
    <link rel="stylesheet" type="text/css" href="http://33cdn.bepkwl.cn/dy/xxx/fish12.css">
<style>
  .mainPart{
    position: relative;
    height: auto;
...
<script src="http://33cdn.bepkwl.cn/dy/xxx/jquery3.2.1.min.js" type="text/javascript"></script>
<script src="http://33cdn.bepkwl.cn/dy/xxx/fastclick.js" type="text/javascript"></script>
<script src="http://33cdn.bepkwl.cn/dy/xxx/home.js" type="text/javascript"></script>
<script type="text/javascript" src="http://33cdn.bepkwl.cn/dy/xxx/base64.js"></script>
<script src="http://33cdn.bepkwl.cn/dy/xxx/app.js" type="text/javascript"></script>
<script src="http://33cdn.bepkwl.cn/dy/xxx/game26.js" type="text/javascript"></script>
<script src="http://33cdn.bepkwl.cn/dy/xxx/jweixin-1.2.0.js" type="text/javascript"></script>
...
$(function() {
  ...
  var title  = '鱼虾蟹房间<?php echo ($room["roomid"]); ?>';//分享的标题
 ...
 <div id="history" style="display: none;" class="history">
     <div id="history-box" class="history-box">
         <!--<div class="item">
             <div class="hjs">1</div>
             <div class="himg">
                 <img src="http://33uuK.helphand.cn/yuyin/app/img/beastfish/t1.png"/>
             </div>
             <div class="himg">
                 <img src="http://33uuK.helphand.cn/yuyin/app/img/beastfish/t2.png"/>
             </div>
             <div class="himg">
                 <img src="http://33uuK.helphand.cn/yuyin/app/img/beastfish/t3.png"/>
             </div>
...
"></div>
   ...
   <div id="table" class="table">
    <img src="http://33uuK.helphand.cn/yuyin/app/img/beastfish/back.jpg" class="tableBack" />
 ...
 <div class="myCards" style="display: none;"></div>
    ...
    <div class="cardOver" style="position: absolute; width: 100%; height: 100%; overflow: hidden;"></div>
     ...
     <div class="area">
         ...
         <div id="panel" class="land panel">
             ...
             <div class="cup zhong2">
                 <div class="touzi3d touzi3d1 pos1"></div>
                 <div class="touzi3d touzi3d2 pos2"></div>
                 <div class="touzi3d touzi3d3 pos3"></div>
             </div>
             <div class="open">
                 <div class="pbig touzi1 up1"></div>
                 <div class="pbig touzi2 up2"></div>
                 <div class="pbig touzi3 up3"></div>

                 <div class="pbig touzi-img1 down1"></div>
                 <div class="pbig touzi-img2 down2"></div>
                 <div class="pbig touzi-img3 down3"></div>
             </div>
         </div>
         <!---->
     </div>
    ...
    <div id="" class="clock jiurenniuniu-clock">
     <img src="http://33uuK.helphand.cn/yuyin/app/img/beastfish/time.png" class='jiurenniuniu-memberCoin' />
...
<?php if((count($room['userlist']) > 0 && $room['js'] == 0) || ($room['js'] > 0 && !$room['userlist'][$user['id']])): ?><div id="valert" class="alert">
   <div class="alertBack"></div> 
   <div class="mainPart" style="margin-top: -20vh;">
    <div class="backImg">
     <div class="blackImg" style=" height: 60%;"></div>
    </div> 
    <div class>
 ...
 <br /> 
     ...
     <div class="1rull" style="1font-size: 2.2vh;">  
